...
* MCTQ: Weights and activations values are quantized but represented in float32 dtype. In this format we use custom quantizer layers - [mct_quantizers](https://github.com/SonySemiconductorSolutions/mct-quantization-layers#readme).
